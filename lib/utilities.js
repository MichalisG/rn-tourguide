...
export const defaultSvgPath = ({ size, position, borderRadius: radius, borderRadiusObject, }) => {
    ...
    if (radius || borderRadiusObject) {
        ...
        return `M${position.x + borderRadiusTopRight},${position.y + MARGIN}H${position.x + size.x- borderRadiusTopRight - MARGIN} a${borderRadiusTopRight},${borderRadiusTopRight} 0 0 1 ${borderRadiusTopRight},${borderRadiusTopRight}V${position.y + size.y - borderRadiusTopRight- MARGIN} a${borderRadiusBottomRight},${borderRadiusBottomRight} 0 0 1 -${borderRadiusBottomRight},${borderRadiusBottomRight}H${position.x + borderRadiusBottomLeft + MARGIN} a${borderRadiusBottomLeft},${borderRadiusBottomLeft} 0 0 1 -${borderRadiusBottomLeft},-${borderRadiusBottomLeft}V${position.y +
