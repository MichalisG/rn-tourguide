...
let Modal = (() => {
    class Modal extends React.Component {
        constructor(props) {
            ...
            this.renderMask = () => (React.createElement(SvgMask, { style: styles.overlayContainer, size: this.state.size, position: this.state.position, easing: this.props.easing, animationDuration: this.props.animationDuration, backdropColor: this.props.backdropColor, currentStep: this.props.currentStep, maskOffset: this.props.maskOffset, borderRadius: this.props.borderRadius }));
        }
        ...
        renderTooltip() {
            ...
            return (React.createElement(Animated.View, { pointerEvents: 'box-none', key: 'tooltip', style: [
                ...
                React.createElement(TooltipComponent, { isFirstStep: this.props.isFirstStep, isLastStep: this.props.isLastStep, currentStep: this.props.currentStep, stepsNumber: this.props.stepsNumber, handleNext: this.handleNext, handlePrev: this.handlePrev, handleStop: this.handleStop, labels: this.props.labels, tooltipTranslateY: this.state.tooltipTranslateY, tooltip: this.state.tooltip, tooltipBody: this.props.tooltipBody, onNext: this.props.onNext, onPrev: this.props.onPrev })));
        }
        renderTopLayer() {
            ...
            return (React.createElement(TopLayerComponent, { isFirstStep: this.props.isFirstStep, isLastStep: this.props.isLastStep, currentStep: this.props.currentStep, stepsNumber: this.props.stepsNumber, handleNext: this.handleNext, handlePrev: this.handlePrev, handleStop: this.handleStop, labels: this.props.labels }));
        }
        render() {
            ...
            return (React.createElement(View, { style: [StyleSheet.absoluteFill, { backgroundColor: 'transparent' }], pointerEvents: 'box-none' },
                React.createElement(View, { style: styles.container, onLayout: this.handleLayoutChange, pointerEvents: 'box-none' },
                    contentVisible && (React.createElement(React.Fragment, null,
                        this.renderMask(),
                        this.renderTooltip())),
