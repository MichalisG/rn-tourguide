    ...
    class Modal extends React.Component {
        ...
        renderTooltip() {
            ...
            return (React.createElement(Animated.View, { pointerEvents: 'box-none', key: 'tooltip', style: [
                ...
                React.createElement(TooltipComponent, { isFirstStep: this.props.isFirstStep, isLastStep: this.props.isLastStep, currentStep: this.props.currentStep, stepsNumber: this.props.stepsNumber, handleNext: this.handleNext, handlePrev: this.handlePrev, handleStop: this.handleStop, labels: this.props.labels })));
        }
        renderTopLayer() {
            ...
            return (React.createElement(View, { pointerEvents: 'box-none', key: 'topLayer', style: this.props.topLayerStyle },
                React.createElement(TopLayerComponent, { isFirstStep: this.props.isFirstStep, isLastStep: this.props.isLastStep, currentStep: this.props.currentStep, stepsNumber: this.props.stepsNumber, handleNext: this.handleNext, handlePrev: this.handlePrev, handleStop: this.handleStop, labels: this.props.labels })));
        }
        render() {
