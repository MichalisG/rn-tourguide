...
let Modal = (() => {
    class Modal extends React.Component {
        ...
        renderTopLayer() {
            ...
            return (React.createElement(TopLayerComponent, { isFirstStep: this.props.isFirstStep, isLastStep: this.props.isLastStep, currentStep: this.props.currentStep, stepsNumber: this.props.stepsNumber, handleNext: this.handleNext, handlePrev: this.handlePrev, handleStop: this.handleStop, handlersProps: this.props.handlersProps, labels: this.props.labels }));
        }
        render() {
