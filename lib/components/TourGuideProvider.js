...
export const TourGuideProvider = ({ children, wrapperStyle, labels, tooltipComponent, tooltipStyle, topLayerComponent, androidStatusBarVisible, backdropColor, animationDuration, maskOffset, borderRadius, verticalOffset, startAtMount = false, }) => {
    ...
    const unregisterStep = (stepName) => {
        ...
        setSteps((previousSteps) => {
            return Object.entries(previousSteps)
    ...
    return (React.createElement(View, { style: [styles.container, wrapperStyle] },
        React.createElement(TourGuideContext.Provider, { value: {
            ...
            React.createElement(Modal, Object.assign({ ref: modal }, {
                ...
                maskOffset,
                borderRadius,
                stepsNumber: utils.getStepNumber(steps)
            })))));
};
